"""Schemas for MT940 processing endpoints."""
...
class MT940SearchRequest(BaseModel):
    statement: str = Field(..., description="Raw MT940 statement content.")
...
class MT940TransactionModel(BaseModel):
...
class MT940SearchResponse(BaseModel):
    matches: List[MT940TransactionModel]
    matched_count: int
    total_matches: int
