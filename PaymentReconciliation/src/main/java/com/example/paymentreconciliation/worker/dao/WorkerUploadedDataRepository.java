...
public interface WorkerUploadedDataRepository extends JpaRepository<WorkerUploadedData, Long> {
    ...
    Page<WorkerUploadedData> findByFileIdAndStatusAndUploadedAtBetween(String fileId, String status, 
            LocalDateTime startDate, LocalDateTime endDate, Pageable pageable);
    
    Page<WorkerUploadedData> findByFileIdAndUploadedAtBetween(String fileId, 
            LocalDateTime startDate, LocalDateTime endDate, Pageable pageable);
