...
public interface WorkerUploadedDataRepository extends JpaRepository<WorkerUploadedData, Long> {
    ...
    // Find all data within a date range
    Page<WorkerUploadedData> findByCreatedAtBetween(LocalDateTime startDate, LocalDateTime endDate, Pageable pageable);    void deleteByFileId(String fileId);
}
