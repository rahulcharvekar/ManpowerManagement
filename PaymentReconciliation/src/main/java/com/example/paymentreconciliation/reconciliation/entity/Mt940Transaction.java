package com.example.paymentreconciliation.reconciliation.entity;
...
public class Mt940Transaction {
    ...
    public Mt940Transaction(String transactionReference, BigDecimal amount, LocalDate valueDate, 
                           String debitCreditIndicator, String narrative, String accountNumber) {
