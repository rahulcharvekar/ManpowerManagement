...
) ENGINE=InnoDB AUTO_INCREMENT=126 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Actions available on UI pages';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `roles` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='User roles';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `roles` VALUES (1,'ADMIN','System Administrator with full access','2025-10-09 15:45:44','2025-10-09 15:45:44',1),(2,'RECONCILIATION_OFFICER','Payment Reconciliation Officer','2025-10-09 15:45:44','2025-10-09 15:45:44',1),(3,'WORKER','Worker role with worker-related access','2025-10-09 15:45:44','2025-10-09 15:45:44',1),(4,'EMPLOYER','Employer role with employer-related access','2025-10-09 15:45:44','2025-10-09 15:45:44',1),(5,'BOARD','Board member with approval authority','2025-10-09 15:45:44','2025-10-09 15:45:44',1);
...
INSERT INTO `user_roles` VALUES (1,1,1,'2025-10-10 09:07:54');
...
-- Dump completed on 2025-10-12  8:58:03
